...
if(it.hasNext())
{
	...
	<form action="Deleteser" method="post">
	 ...
	 <br><br>
	 <input type="text" value="<%= sss.getSname() %>"  name="txtsname" readonly="readonly"/>
	 <br><br>
	 <input type="text" value="<%= sss.getBranch() %>"  name="txtbranch" readonly="readonly" />
	 <br><br>
	 <input type="text" value="<%= sss.getFees() %>"  name="txtfees" readonly="readonly" />
	 <br><br>
